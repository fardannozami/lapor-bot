...
var (
	motivationalQuotes = []string{
		...
		// === Pepatah Tiongkok Kuno: Kesehatan, Olahraga, dan Kebijaksanaan Tubuh-Pikiran ===
		"🏮 \"Perjalanan seribu mil dimulai dengan satu langkah.\" — Lao Tzu",
		"🏮 \"Pohon besar tumbuh dari tunas kecil. Tubuh kuat dibangun dari kebiasaan kecil sehari-hari.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Orang bijak menjaga tubuh seperti menjaga api: tidak terlalu besar, tidak terlalu kecil, tapi selalu menyala.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Kesehatan adalah harta terbesar. Kepuasan adalah kekayaan terbesar. Kepercayaan adalah sahabat terbesar.\" — Lao Tzu",
		"🏮 \"Tubuh yang lembut dan lentur adalah sahabat kehidupan. Tubuh yang kaku adalah sahabat kematian.\" — Lao Tzu",
		"🏮 \"Kekuatan terbesar bukan terletak pada otot, tapi pada tekad yang tidak goyah.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Seperti air yang mengikis batu — bukan karena kekuatannya, tapi karena ketekunannya. Begitu pula olahraga.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Gerakan menjaga vitalitas, seperti engsel pintu yang tidak pernah berkarat.\" — Lüshi Chunqiu (Lü Buwei, 239 SM)",
		"🏮 \"Tabib agung menyembuhkan penyakit sebelum muncul. Jagalah kesehatan sebelum sakit.\" — Huangdi Neijing",
		"🏮 \"Makan tidak boleh terlalu kenyang. Gerak tidak boleh terlalu lelah. Keseimbangan adalah kunci panjang umur.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Pikiran yang tenang, tubuh yang aktif — itulah jalan panjang umur.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Latihan adalah investasi. Sakit adalah biaya yang jauh lebih mahal.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Orang yang kuat bukan yang menang dalam pertarungan, tapi yang menguasai dirinya sendiri.\" — Confucius",
		"🏮 \"Tubuh yang sehat menyimpan jiwa yang kuat. Rawat wadahnya, maka isinya akan bersinar.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Seribu mil berlari dimulai dari sepasang kaki.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Air yang mengalir tidak pernah busuk. Tubuh yang bergerak tidak pernah sakit.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Gerak adalah yang, diam adalah yin. Keseimbangan keduanya adalah kesehatan sejati.\" — Prinsip Tao Kuno",
		"🏮 \"Jangan mencari obat untuk penyakit yang bisa dicegah dengan gerakan.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Bambu yang lentur tidak patah oleh angin. Tubuh yang aktif tidak rapuh oleh zaman.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Setiap hari kurangi sedikit, setiap hari gerakkan sedikit. Itulah jalan panjang umur.\" — Lao Tzu (disadurkan)",
		"🏮 \"Tabib terbaik mengajarkan manusia hidup sehat, bukan mengobati manusia sakit.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Langit sehat karena bergerak tanpa henti. Manusia sehat karena demikian pula adanya.\" — I Ching (Kitab Perubahan)",
		"🏮 \"Orang yang menguasai pikiran menguasai segalanya. Mulailah dari tubuh.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Disiplin tubuh adalah cermin disiplin jiwa. Tanpa yang satu, yang lain rapuh.\" — Pepatah Tiongkok Kuno",
		"🏮 \"Kekuatan batin lahir dari tubuh yang terlatih. Pikiran jernih lahir dari jiwa yang tenang.\" — Pepatah Tiongkok Kuno",
	}
)
